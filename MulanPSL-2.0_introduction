...
## Mulan PSL v2产业化使用情况？
截至2020年11月，已有1万七千余项国内自主开源项目支持应用木兰宽松许可证，已得到Linux基金会、Apache基金会、华为、阿里、开源中国、CSDN等开源组织、公司和代码托管平台的支持应用。
1.国家科技项目成果优先使用木兰系列许可证发布项目
2.部分企业如华为、小米等，部分开源项目，如方舟编译器、高斯、欧拉等
3.地方开源组织：如上海“白玉兰开源开放研究院”，在人工智能领域支持和应用木兰许可证；开放原子基金会，参与并支持木兰许可证
4.基金会： Linux基金会、Apache基金会等
