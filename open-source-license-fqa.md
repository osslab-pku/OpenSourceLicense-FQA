...
答：如果这个软件没有其他贡献者，软件的作者可以直接将许可证由Apache替换为MulanPSL v2；
...
答：2020年2 月 14 日，开源促进会(OSI，Open Source Initiative)将木兰开源许可证第二版(MulanPSL v2)批准为“国际类别(International)”开源许可证，同时OSI 许可证审查委员会表示“中文版开源许可证可以鼓励中国社区参与开源，同时也是对已批准许可证列表的宝贵补充”。   
...
### 问：木兰许可证的取名由来？
答：《木兰辞》有言：万里赴戎机，关山度若飞。翱翔着翻越关隘和山岭，或许这正是木兰协议团队当时以“木兰”为名的原因。

### 问：木兰许可证制定的时代背景？
答：国内此前也有一批个人/公司发起自己的“国产开源协议”，但是并没有像木兰推出时引起的轰动，纠其原因主要有两点，一是木兰协议的出身背景，二是国际形势使然。    
...
### 问：制定木兰许可证面临的主要困难和挑战？
答：MulanPSL v2完成了申请与认证的过程，需要有大量的前期准备工作。首先，木兰许可证的制定必须建立在对现有开源许可证的充分理解之上，而对现有开源许可证的准确分析是比较困难且耗时的，北大、西南大学与中科院软件所等参与协议制定的老师与同学为此贡献了很多时间和精力。其次，木兰许可证制定的初衷是推出一个便于开发者理解、保护开发者利益且广泛使用的中国本土开源许可证，因此如何充分保护开发者利益以及如何突显中国特色也是制定木兰许可证的难点。国内企业的法务专家为该项目提供了非常好的咨询。    
...
答：与众多开源协议相比，Mulan PSL 的主要优势在于更完善的专利授权。具体来说，Mulan PSL 在其它协议的基础上进行了以下优化：   
...
答：Mulan PSL v2 与 Mulan PSL v1 本质上没有区别，Mulan PSL v2 是在 Mulan PSL v1 基础上的进一步完善。认证过程中，OSI 及社区其他专家并没有表示 Mulan PSL v1 不符合开源定义，仅对规范语言和部分英文表述问题给出了相关建议。Mulan PSL v2相较于Mulan PSL v 1，有如下特点：   
...
答：Mulan PSL v2，该版本增加了语言条款，声明中文为规范语言，也就是在与英文版本发生冲突时以中文为准。

### 问：木兰宽松许可证的发展历史及应用现状？
答：    
- 发展历史： 
    2019年8月5日，《木兰宽松许可证，第 1 版》(Mulan PSL v1)在中国开源云联盟官网正式上线。    
    2019年12月3日，木兰协议牵头人周明辉向开源促进会(OSI)提出Mulan PSL v1的认证申请。     
    随后，OSI 社区在邮件列表中对木兰展开了公开讨论，主要集中在两点：一是Mulan PSL v1 与现有协议之间的区别，如 BSD+patents；二是多语言问题，Mulan PSL 采用中英双语，但两种语言的解释可能冲突从而存在潜在风险。     
    2019年12月30日，木兰协议牵头人周明辉向开源促进会(OSI)提出Mulan PSL v2的认证申请。Mulan PSL v2中增加了语言条款，声明中文为规范语言。      
    2020年1月6日，向开源促进会(OSI)再次提交修改后的Mulan PSL v2。在该版本中修改了可能引起歧义的表述，并调整英文版语言条款和免责条款的格式。      
    2020年2月11日，OSI 许可证审查委员会发出邮件，建议将 Mulan PSL v2 批准为“国际类别(International)”开源许可证，同时表示“中文版开源许可证可以鼓励中国社区参与开源，同时也是对已批准许可证列表的宝贵补充”。      
    2020年2月13日，《木兰宽松许可证，第 2 版》(Mulan PSL v2)在中国开源云联盟官网正式上线。      
    2020年2月14日，OSI 董事会正式发出邮件，批准《木兰宽松许可证，第2版》(Mulan PSL v2)为国际类别开源许可证（International licenses）。     
    2021年3月24日，日本开源组织OSGJ（Open Source Group Japan）翻译并发布了木兰宽松许可证日文版。      
- 应用现状：   
    2019年8月，码云 Gitee平台率先支持Mulan PSL v1。      
    随后，Mulan PSL v1先后得到开源中国和Linux基金会在内的多个国内外代表性开源社区的支持，以及包括华为方舟编译器在内的超过1700个开源项目中的落地应用，同时 Tweet 上也有不少评论表明国外个人开发者对木兰协议的喜爱与支持。      
    2020年2月13日，码云 Gitee平台支持Mulan PSL v2。      
    Mulan PSL v2上线期间正值抗击新冠肺炎疫情的关键时期，自2月13日上线以来，已得到包括“疫战2020疫情防护语料库”、“出入人员登记系统”等疫情防控信息化开源项目的支持采用，为抗击新冠肺炎疫情的信息化工作提供支持保障。      
    截至2020年11月，已有1万七千余项国内自主开源项目支持应用木兰宽松许可证，得到Linux基金会、Apache基金会、华为、阿里、开源中国、CSDN等开源组织、公司和代码托管平台的支持应用，项目类型涵盖包括云计算、大数据、人工智能、开发框架等应用软件，以及操作系统、数据库等基础软件和中间件。    
    截止2022年6月，Libraries.io上已有超过6900个开源包应用了木兰宽松许可证。  

- 木兰宽松许可证申请OSI的认证过程：
![木兰认证过程 - 时间轴](https://user-images.githubusercontent.com/24621557/172521158-2ad9d054-d9e4-4890-9f3d-8986c1e8e226.png)

### 问：木兰发展前景？
答：木兰也只是个开源许可证，核心产出还需要体现在开源项目和技术上，以及相关的开源生态上。木兰相关生态的一些规划主要有两点：   
